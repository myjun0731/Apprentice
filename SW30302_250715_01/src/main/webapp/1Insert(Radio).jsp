		...
		<form action="1Insert_Detail.jsp" name="form">
			<table border="1">
				<tr>
					<td>타자선택</td>
					<td>
						<input type="radio" name="registration_code" value="A001">[A001]김길동<br>
						<input type="radio" name="registration_code" value="A005">[A005]이길동<br>
						<input type="radio" name="registration_code" value="B002">[B002]홍길동<br>
						<input type="radio" name="registration_code" value="B006">[B006]조길동<br> 
					</td>
				</tr>
				<tr>
